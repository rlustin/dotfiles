...
#$LINE1
PACES=${(l:TERMWIDTH - (LINE1_LENGTH + SSH_P_LENGTH):: :)}
...
PATH=$PATH:~/Documents/Dev/moz-git-tools

PROMPT='${PROMPT_LINE}:${PR_PWDCOLOR}%~${PR_RESET}${vcs_info_msg_0_}%(!.%B%F{red}%#%f%b.%B%F{green}➤%f%b) '

# alias for keyringer pierre
alias k="keyringer pierre"
